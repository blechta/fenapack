"""Flow over a backward-facing step without the inlet part of the channel.
...
# Prepare mesh
channel_length = 5.0
bot_corner = Point(0.0, -1.0)
top_corner = Point(channel_length, 1.0)
mesh = RectangleMesh(comm, bot_corner, top_corner,
                     int(channel_length), 2, "left")
# Refinement
...
solver = NewtonSolver(inner_solver)
